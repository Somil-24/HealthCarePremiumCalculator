...
# Load the models and scalers using proper path joining
model_young = joblib.load(current_dir / "artifacts" / "model_young.joblib")
model_rest = joblib.load(current_dir / "artifacts" / "model_rest.joblib")
scaler_young = joblib.load(current_dir / "artifacts" / "scaler_young.joblib")
scaler_rest = joblib.load(current_dir / "artifacts" / "scaler_rest.joblib")
